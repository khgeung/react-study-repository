    ...
    <div className="app">
      ...
      <div className="card-grid">
        ...
        <Card
          category="React"
          title="컴포넌트와 Props"
          description="React 핵심 개념인 컴포넌트와 Props 를 학습"
          author="손흥민"
          date="2025-9-10"
        ...
        <Card
          category="Javascript"
          title="ES6+ 문법정리"
          description="화살표함수, 구조분해할당, 스프레드 연산자 등"
          author="조규성"
          date="2025-9-10"
        ...
        */}
        <Card
          ...
          description="React Bootstrap Grid system 으로 반응형 웹을 구현"
          date="2025-9-10"
          image="https://picsum.photos/400/300?random=3"
        />
        {/* 
          author 와 date 를 전달하지 않고 Card 컴포넌트 jsx 조건식 테스트 
        */}
        <Card
        ...
        />
        {/* 
            최소한의 정보만 전달, 이번에는 category 도 전달하지 않아본다
